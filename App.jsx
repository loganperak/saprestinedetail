  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <header className="p-4 bg-white shadow">
        <h1 className="text-3xl font-bold text-center">Your Business Name</h1>
      </header>
      <main className="max-w-4xl mx-auto p-6 space-y-8">
        <section>
          <h2 className="text-2xl font-semibold">Welcome</h2>
          <p className="text-gray-600">We provide high-quality local services throughout Chicagoland.</p>
        </section>
        <section>
      ...
      <footer className="p-4 text-center text-gray-500 border-t">© {new Date().getFullYear()} Your Business Name</footer>
    </div>
  )
}
